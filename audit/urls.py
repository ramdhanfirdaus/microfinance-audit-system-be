...
from audit.views.views_categories import get_audit_categories, get_audit_categories_by_session, post_audit_category, get_all_audit_categories
...
urlpatterns = [
    ...
    path('audit-categories-by-session/<str:session_id>', get_audit_categories_by_session, name="get_audit_categories_by_session"),
